		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid" style="background-color: aliceblue;">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">facedInterview <span
							class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="http://localhost:8090/interview/logout">click
									here for LogOut</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
			...
			<div class="row content">
				<div class="col-sm-2 sidenav">
					<ul class="nav navbar-nav"
						...
						<li><a href="getOnClickDataByQuestion?keyword=class"
						...
						<li><a href="getOnClickDataByQuestion?keyword=Requirements"
